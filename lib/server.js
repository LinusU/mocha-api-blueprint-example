...
Server.prototype.handle = function (req) {
  ...
  function json (status, data, location) {
  ...
  switch (head) {
    ...
    case 'POST /users':
      ...
      return json(201, user, '/users/' + user.id)
    case 'GET /users':
    ...
    case 'POST /sessions':
      ...
      return json(201, session, '/sessions/' + session.id)
    ...
    case 'POST /messages':
      ...
      return json(201, message, '/messages/' + message.id)
    case 'GET /messages':
